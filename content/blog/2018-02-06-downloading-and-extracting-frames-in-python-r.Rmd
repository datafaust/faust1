---
title: Downloading and Extracting Frames in Python & R
author: Fausto Lopez
date: '2018-02-06'
slug: downloading-and-extracting-frames-in-python-r
categories:
  - computer vision
tags:
  - computer vision
...
#directory
setwd("C:/Users/fausto/Documents/incubator_img_recog/plane_classifier/drone_proj/r_tests")
...
the_vid = Rvision::video("C:/Users/fausto/Documents/incubator_img_recog/plane_classifier/drone_proj/r_tests/Video_1.avi")
nframes(the_vid)#shows us the number of frames
my_frame = readFrame(the_vid,3)
plot(my_frame)
release.Rcpp_Video(the_vid) #i believe like closing an odbc connection this is good practice
```
...
#rvision wants us to create a video object
the_vid = video("C:/Users/fausto/Documents/incubator_img_recog/plane_classifier/drone_proj/r_tests/Video_1.avi")
...
```{r, echo = T, warning=F, eval=F, error=F}
 ...
 #set directory
 os.chdir("C:\\Users\\fausto\\Documents\\incubator_img_recog\\plane_classifier\\drone_proj\\videos\\drones")
 ...
 while True:
     ...
     os.chdir("C:\\Users\\fausto\\Documents\\incubator_img_recog\\plane_classifier\\drone_proj\\fl_new_pics")
